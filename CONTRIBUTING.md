...
posted to #FreeDomCrypto-dev on irc.freenode.net).
...
The "FreeDomCrypto Maintainer Team" is defined in this document as the following users:
- fluffypony
- FreeDomCryptomooo
- hyc
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to FreeDomCrypto code or FreeDomCrypto's dependency code or FreeDomCrypto's potential/future dependency code or research which successfully implements FreeDomCrypto.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the FreeDomCrypto Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the FreeDomCrypto Maintainer Team.
